  ...
  <div class='box upload'>
    ...
    <Code>
        <template slot='source'>
            <gl-upload
                ...
                :file-list="fileList">
                <gl-button size="small" type="primary">点击上传</gl-button>
                <div slot="tip" class="gl-upload__tip" style="font-size: 12px;
                color: #606266;
                margin-top: 7px;">只能上传jpg/png文件，且不超过500kb</div>
            </gl-upload>
        </template>
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                <span class="hljs-tag">&lt;<span class="hljs-name">gl-upload</span>
                    ...
                    <span class="hljs-tag">&lt;<span class="hljs-name">gl-button</span> <span class="hljs-attr">size</span>=<span class="hljs-string">"small"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span>&gt;</span>点击上传<span class="hljs-tag">&lt;/<span class="hljs-name">gl-button</span>&gt;</span>
                ...
                <span class="hljs-tag">&lt;/<span class="hljs-name">gl-upload</span>&gt;</span>
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                ...
                <span class="hljs-tag">&lt;<span class="hljs-name">style</span>&gt;</span><span class="css">
                    <span class="hljs-selector-class">.avatar-uploader</span> <span class="hljs-selector-class">.gl-upload</span> {
                    ...
                    <span class="hljs-selector-class">.avatar-uploader</span> <span class="hljs-selector-class">.gl-upload</span><span class="hljs-selector-pseudo">:hover</span> {
    ...
    <Code>
        <template slot='source'>
            ...
            <gl-dialog :visible.sync="dialogVisible">
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                <span class="hljs-tag">&lt;<span class="hljs-name">gl-upload</span>
                    ...
                    <span class="hljs-tag">&lt;/<span class="hljs-name">gl-upload</span>&gt;</span>
                    <span class="hljs-tag">&lt;<span class="hljs-name">gl-dialog</span> <span class="hljs-attr">:visible.sync</span>=<span class="hljs-string">"dialogVisible"</span>&gt;</span>
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                ...
                <span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
                    data() {
                        <span class="hljs-keyword">return</span> {
                            <span class="hljs-attr">fileList2</span>: [{<span class="hljs-attr">name</span>: <span class="hljs-string">'footer_logo.png'</span>, <span class="hljs-attr">url</span>: <span class="hljs-string">'http://www.didihu.com.cn/ddhpc/images/footer_logo.png'</span>}, {<span class="hljs-attr">name</span>: <span class="hljs-string">'footer_logo2.png'</span>, <span class="hljs-attr">url</span>: <span class="hljs-string">'http://www.didihu.com.cn/ddhpc/images/footer_logo.png'</span>}]
                        };
                    },
                    <span class="hljs-attr">methods</span>: {
                        handleRemove(file, fileList) {
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                <span class="hljs-tag">&lt;<span class="hljs-name">gl-upload</span>
                    ...
                    <span class="hljs-tag">&lt;<span class="hljs-name">gl-button</span> <span class="hljs-attr">size</span>=<span class="hljs-string">"small"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span>&gt;</span>点击上传<span class="hljs-tag">&lt;/<span class="hljs-name">el-button</span>&gt;</span>
                    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"tip"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"gl-upload__tip"</span>&gt;</span>只能上传jpg/png文件，且不超过500kb<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
                <span class="hljs-tag">&lt;/<span class="hljs-name">gl-upload</span>&gt;</span>
                <span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
                <span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
                    data() {
    ...
    <Code>
        <template slot='source'>
            ...
            :file-list="fileList"
            :auto-upload="false">
            <gl-button slot="trigger" size="small" type="primary">选取文件</gl-button>
            <gl-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">上传到服务器</gl-button>
            <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>
            </gl-upload>
        </template>
        <template slot='description'>
        ...
        <template slot='highlight'>
            <pre><code class="hljs language-html">
                <span class="hljs-tag">&lt;<span class="hljs-name">gl-upload</span>
                    ...
                    <span class="hljs-tag">&lt;<span class="hljs-name">gl-button</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"trigger"</span> <span class="hljs-attr">size</span>=<span class="hljs-string">"small"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"primary"</span>&gt;</span>选取文件<span class="hljs-tag">&lt;/<span class="hljs-name">gl-button</span>&gt;</span>
                    <span class="hljs-tag">&lt;<span class="hljs-name">gl-button</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"margin-left: 10px;"</span> <span class="hljs-attr">size</span>=<span class="hljs-string">"small"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"success"</span> <span class="hljs-attr">@click</span>=<span class="hljs-string">"submitUpload"</span>&gt;</span>上传到服务器<span class="hljs-tag">&lt;/<span class="hljs-name">gl-button</span>&gt;</span>
                    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">"tip"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"el-upload__tip"</span>&gt;</span>只能上传jpg/png文件，且不超过500kb<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
                <span class="hljs-tag">&lt;/<span class="hljs-name">gl-upload</span>&gt;</span>
                <span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
                <span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> {
  ...
  export default {
    ...
    data () {
      return {
          ...
          fileList2: [{name: 'footer_logo.png', url: 'http://www.didihu.com.cn/ddhpc/images/footer_logo.png'}, {name: 'footer_logo2.png', url: 'http://www.didihu.com.cn/ddhpc/images/footer_logo.png'}],
          fileList3: [{
            name: 'food.jpeg',
          ...
          table: {
              data: [
                ...
                {
                   parameter: 'accept',
                   state: '接受上传的文件类型（thumbnail-mode 模式下此参数无效）',
                   mold: 'string',
                   choose: '—',
                   default: '—'
                },
                ...
                },
                {
                   ...
                   state: '文件上传成功时的钩子',
                   mold: 'function(response, file, fileList)',
                   choose: '—',
                   default: '—'
                },
                {
                   parameter: 'on-error',
                   state: '文件上传失败时的钩子',
                   mold: 'function(err, file, fileList)',
                   choose: '—',
                   default: '—'
                },
                {
                   ...
                   state: '文件上传时的钩子',
                   mold: 'function(event, file, fileList)',
                   choose: '—',
                   default: '—'
                },
                {
                   parameter: 'on-change',
                   state: '文件状态改变时的钩子，添加文件、上传成功和上传失败时都会被调用',
                   mold: 'function(file, fileList)',
                   choose: '—',
                   default: '—'
                },
                {
                   ...
                   state: '上传文件之前的钩子，参数为上传的文件，若返回 false 或者返回 Promise 且被 reject，则停止上传。',
                   mold: 'function(file)',
                   choose: '—',
                   default: '—'
                },
                {
                   ...
                   state: '删除文件之前的钩子，参数为上传的文件和文件列表，若返回 false 或者返回 Promise 且被 reject，则停止上传。',
                   mold: 'function(file, fileList)',
                   choose: '—',
                   default: '—'
                },
                {
                   ...
                   state: '文件列表的类型',
                   mold: 'string',
                   choose: 'text/picture/picture-card',
                   default: 'text'
                },
                {
                   parameter: 'auto-upload',
                   state: '是否在选取文件后立即进行上传',
                   mold: 'boolean',
                   choose: '—',
                   default: 'true'
                },
                {
                   parameter: 'file-list',
                   state: "上传的文件列表, 例如: [{name: 'food.jpg', url: 'https://xxx.cdn.com/xxx.jpg'}]",
                   mold: 'array',
                   choose: '—',
                   default: '[]'
                },
...
<style>
  ...
  .upload .el-upload-list__item-thumbnail{
      width: 193px;
      height: 66px;
  }
</style>
