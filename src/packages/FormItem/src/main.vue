  ...
  export default {
    ...
    methods: {
      ...
      resetField() {
        ...
        this.broadcast('GlTimeSelect', 'fieldReset', this.initialValue);
      },
      getRules() {
    ...
    mounted() {
      if (this.prop) {
        this.dispatch('GlForm', 'el.form.addField', [this]);
    ...
    beforeDestroy() {
      this.dispatch('GlForm', 'el.form.removeField', [this]);
    }
  };
</script>
